...
1. In the **Create a virtual machine** blade, perform the following steps:

    a. Leave the **Subscription** field set to its default value.
    
    a. In the **Resource group** section, click the **Create new** link.

    a. In the **Resource group** section, enter the value **MOD03VDSC**  into the empty field.
    
    a. In the **Virtual machine name** field, enter the value **autoconfigvm**.
    
    a. In the **Region** field, select the **East US** location.
    
    a. In the **Image** field, make sure the **Windows Server 2016 Datacenter** option is selected.
    
    a. In the **Size** field, click the **Change size** link.
    
    a. In the **Select a VM size** select the **DS2_V2** size and click the **Select** button.
...
1. In the **Disks** tab perform the following steps:
    ...
    a. In the **OS disk type** option, make sure the **Premium SDD** option is selected. 
    
    a. In the **Use unmanaged disks** option, select the option **No**.
    
    a. Click the **Review + create** button.

1. The **Review & Create** tab, review all the select options and then click **Create** to create the virtual machine using your specified configuration..
